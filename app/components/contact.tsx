...
function Contacts(){
    return <section id="contacts" className="flex flex-wrap w-screen pt-16">
        <h2 className="flex w-full justify-center mb-16">Contacts</h2>
        <div className="w-full sm:w-1/2 grid grid-cols-2">
            <a href="tel:+261346058262" target="_blank" className="flex flex-col justify-center items-center">
                <button>
                    <FaPhone/>
                </button>
                <p>+261 34 60 582 62</p>
            </a>
            <a className="flex flex-col justify-center items-center" href="mailto:lantosoamirindra@gmail.com" target="_blank">
                <button>
                    <FaEnvelope/>
                </button>
                lantosoamirindra@gmail.com
            </a>
            <a className="flex flex-col justify-center items-center" href="https://wa.me/261346058262?text=Hi%20Mirindra" target="_blank">
                <button>
                    <FaWhatsapp/>
                </button>
                WhatsApp
            </a>
            <a className="flex flex-col justify-center items-center" href="https://m.me/mih.19.11" target="_blank">
                <button>
                    <FaFacebookMessenger/>
                </button>
                Messenger
        ...
        <form className="flex flex-wrap w-full sm:w-1/2 px-4 sm:px-20">
