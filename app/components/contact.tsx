    ...
    return <section id="contacts" className="flex flex-wrap w-screen pt-16">
        ...
        <div className="w-full sm:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-x-8">
            <a href="tel:+261346058262" target="_blank"
                className="flex flex-col sm:bg-nav justify-center items-center my-2 p-4 rounded-md shadow-inner shadow-blue-900
                bg-gradient-to-b from-arriere via-arriere via-arriere to-blue-900
                hover:shadow-lg hover:shadow-blue-900"
            >
                <button>
                    <FaPhone/>
                </button>
            ...
            <a className="flex flex-col sm:bg-nav justify-center items-center my-2 p-4 rounded-md shadow-inner shadow-blue-900
            bg-gradient-to-b from-arriere via-arriere via-arriere to-blue-900
            hover:shadow-lg hover:shadow-blue-900"
        ...
        <form className="flex flex-wrap w-full sm:w-1/2 px-4 sm:px-10 md:px-20">
            ...
            <label  className="w-full py-2 text-sm" htmlFor="email">Your mail address</label>
            <input  className="w-full px-5 py-2 rounded-md" type="email" name="email" placeholder="example@dom.com" id="email"/>
            <label  className="w-full py-2 text-sm" htmlFor="message">Message</label>
            <textarea  className="w-full rounded-md" name="message" id="msg"></textarea>
            <button className="w-full my-2 py-2 px-2 border rounded-md hover:bg-gray-300 hover:text-blue-800">Submit</button>
        </form>
    </section>
}
